...
ActiveRecord::Schema.define(version: 2020_05_30_233932) do
  ...
  create_table "replies", force: :cascade do |t|
    ...
    t.index ["video_comment_id"], name: "index_replies_on_video_comment_id"
  end
  ...
  add_foreign_key "replies", "video_comments"
